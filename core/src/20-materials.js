/* ============================================================
   The viewport palette. These are the only warm colours in the page —
   the chrome stays cool so the lumber reads.
   ============================================================ */
...
const MATERIALS = {
  ...
  steel:    { c: [0.56, 0.59, 0.63], name: 'Steel tube' },
  steelDk:  { c: [0.41, 0.44, 0.48], name: 'Steel beam' },
  rubber:   { c: [0.23, 0.23, 0.24], name: 'Tyre' },
  foam:     { c: [0.93, 0.87, 0.64], name: 'Rigid foam' },
  ...
  plywood:  { c: [0.84, 0.71, 0.50], name: 'Plywood' },
